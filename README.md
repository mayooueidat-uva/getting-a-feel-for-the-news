...
### [Getting a Feel for the News: Sentiment Analysis and Article Reliability](https://github.com/mayooueidat-uva/getting-a-feel-for-the-news/blob/main/press_release_materials/press_release.md)
## Domain Exposition 
### Terminology table 
| Term | Definition | 
| ----- | --------- | 
...
| -------- | ------- | ------- | ----- |
| Media Content Analysis: Its Uses,<br> Benefits and Best Practice Methodology  |  Academic Periodical   | Used to better understand the importance of media analysis (which is<br> part of my motivation for this project). It was published 20 years ago, but it<br>still contains meaningful research about the effects of mass media. | [OneDrive link](https://myuva-my.sharepoint.com/:b:/g/personal/zvd6vz_virginia_edu/IQBAirg-PaROTrbDMGP0tUc5AdEHz2j4c-ViTHi4pp7zrck?e=4DzZP3) |
| Research Methods for the Creative Arts... | Web Article  | Used to briefly understand the domain of my project (i.e. media analysis)<br> and provides a list of questions I must ask when engaging  with news media. | [OneDrive link](https://myuva-my.sharepoint.com/:u:/g/personal/zvd6vz_virginia_edu/IQDQr5yEsxObR7jL9KaCmXH1AUqaaxaEf8aJole_7NNKVgU?e=4epItp) |
|Understanding Viewer Opinions: Sentiment<br> Analysis on Movie Review using VADER and<br>LSTM Model | Academic Periodical | An article studying the difference in effectiveness of LSTM and VADER<br> sentiment analysis models on assessing emotions conveyed in movie<br> reviews. Used to better understand VADER and its own biases. | [OneDrive link](https://myuva-my.sharepoint.com/:b:/g/personal/zvd6vz_virginia_edu/IQAtbq4i05spQ6n7XQUdjV-mAe-_P0KtPpoMVUEY3VbYExc?e=7lOj4h)
| Cognitive biases in news-making and fact<br>checking: a mixed methods approach| Web Article | Article on how cognitive bias is involved in fact-checking; goes into<br>depth about different froms of cognitive biases. Used for background<br>research on biases present in gauging "reliable" news. | [OneDrive Link](https://myuva-my.sharepoint.com/:u:/g/personal/zvd6vz_virginia_edu/IQAkYPch3CRrRZ5alsa-2-riASQlAMGr2HMdC0sCi4aIYXs?e=s88l51)
| (no title) | Interactive Chart | Ad Fontes Media's interactive chart; plots media outlets based on their<br> reliability and their bias. Logos for outlets can be clicked for more in-depth<br> assessments.| [External link](https://app.adfontesmedia.com/chart/interactive?utm_source=adfontesmedia&utm_medium=website) (interactive)
| Methodology | Web Article | Provides a description of Ad Fontes Media's methodology for assessing<br> the quality of news. Used to understand the metric I'm using and also for<br>bias mitigation.| [OneDrive link](https://myuva-my.sharepoint.com/:u:/g/personal/zvd6vz_virginia_edu/IQAebgM05ZtiTIws5k-cmLhAARaIZorX_8dWLnLJe_pAYsA?e=iAerMw) | 
Methodology - White Paper | Report | A more in-depth description of Ad Fontes Media's methodology and rater<br> qualifications. Used for a more comprehensive understanding of scoring<br>metrics.| [OneDrive link](https://myuva-my.sharepoint.com/:u:/g/personal/zvd6vz_virginia_edu/IQBgkubzufAJSrmMxQ15RhYDAdyscSzn4Jj1--4Ty1BICGs?e=mi1WrH)
Comparative Analysis of VADER and Textblob<br>on Financial News Headlines | Academic Periodical | Compares VADER and Textblob, two popular sentiment analysis tools.<br> Used to select which to use for the project. | [OneDrive link](https://myuva-my.sharepoint.com/:b:/g/personal/zvd6vz_virginia_edu/IQBDHrTmArQAT6j75VBBDm8DATaiJt6bfzk5oVEMf7qSCpM?e=A5rmOI)
...
| --------- | ---------------- | ---- | 
load_clean.py | Fetches all relevant data from NewsAPI, conducts<br>sentiment analysis. | [link](https://github.com/mayooueidat-uva/getting-a-feel-for-the-news/blob/main/code_materials/load_clean.py) | 
transform_analyse.py | Fits a polynomial regression model on sentiment data<br> to predict reliabiltiy. | [link](https://github.com/mayooueidat-uva/getting-a-feel-for-the-news/blob/main/code_materials/transform_analyse.py) |
master_notebook.ipynb | Includes code from the previous two notebooks in addition to analysis rationale. | [link](https://github.com/mayooueidat-uva/getting-a-feel-for-the-news/blob/main/code_materials/master_notebook.ipynb) |
### Bias identification 
...
| ----------- | -------- | ---------|
SOURCE_IDENTIFICATION | Basic identification information of the sources available<br>on NewsAPI.<br> | [link](https://myuva-my.sharepoint.com/:x:/g/personal/zvd6vz_virginia_edu/IQC30MlvccVdSqLqx6NT3SumAcXbK6i8sUjq5sUd0InM7Jo?e=pwFTxn)
SOURCE_AND_RELIABILITY | The Ad Fontes Media bias and reliability scores<br> for news sources used for this project, in addition to<br> their scores' distances from reliability/unreliability thresholds.| [link](https://myuva-my.sharepoint.com/:x:/g/personal/zvd6vz_virginia_edu/IQCHG-A1VCoGS6gBkhGl63WkARkGGm0DF165uSeYky7PYwE?e=id9K29)_
NEWS_ARTICLES | Information about news articles used for the project; the titles<br>will be used for sentiment analysis. | [link](https://myuva-my.sharepoint.com/:x:/g/personal/zvd6vz_virginia_edu/IQAVpGplmZHsQKrozYztLf4qAZgmaLRUAOrQf3OMKMPBLTs?e=p0GIHN)
HEADLINES_SENTIMENTS | Sentiment analysis scores calculated for headlines,<br>as well as titles and source IDs.| [link](https://myuva-my.sharepoint.com/:x:/g/personal/zvd6vz_virginia_edu/IQC7wZulUcCrSY4902zh_6teAWOGP_L64UFo72jSdsKKHg8?e=w9U2zD)
### Data Dictionary 
