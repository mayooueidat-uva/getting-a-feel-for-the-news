...
transform_analyse.py | Fits a polynomial regression model on sentiment data<br> to predict reliabiltiy. | [placeholder](https://github.com/mayooueidat-uva/getting-a-feel-for-the-news/blob/main/code_materials/transform_analyse.py) |
